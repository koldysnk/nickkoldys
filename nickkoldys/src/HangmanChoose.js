...
import {startHangman, makeGuess, updateGuessedLetters, updateNumberOfTries, setGuessedCorrect, setWordToGuess} from './actions';
...
export function HangmanChoose(props) {
    ...
    const onConfirmLength = () => {
        ...
        dispatch(makeGuess(numLetters, makeRegex(), guessed));
    }
